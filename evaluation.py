    ...
    for test_case in range(10):
        ...
        for key in trained_structural_equations:
            if key[1] == action:
                ...
                diff = (abs(predicted_next_state - actual_next_state)) / abs(actual_next_state)
                total_predicted_state_diff += diff
        
        avg_predicted_next_state_diff = ((avg_predicted_next_state_diff * test_case) + total_predicted_state_diff) / (test_case + 1)
